...
<body>
    <main>
            ...
            <div class="stat-card">
                <div class="stat-info">
                    ...
                    <div class="stat-value-row">
                        <span class="stat-number">55555</span>
                    </div>
                </div>
        ...
        <div class="chart-container" style=" margin-top:50px; margin-bottom:100px; position: relative; height:300px; width:100%">
            <div class="chart-header" style="display: flex; justify-content: space-between; align-items: center; padding: 20px;">
                <h3 style="margin: 0; color: #000000; font-weight: 700;">Page Views (Last 30 Days)</h3>

                <select style="padding: 8px 15px; border-radius: 8px; border: 1px solid #e2e8f0; color: #64748b; outline: none;">
